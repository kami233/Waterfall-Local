...
!function(e) {
    ...
    var i = n(1)
      , r = [{
        ...
        title: "Hotkey",
        action: function() {
            alert("pause : space\nScreenshots : F\nforward/backward : left/right rudder\nvolume adjustment : top/bottom rudder")
        }
    }, {
        title: "Speed",
        action: function() {},
    ...
    e.exports = {
        ...
        DEFAULT_CONTEXT_MENU: r,
        PUBLIC_NAMESPACE: "MPlayer",
        UA: o,
        IOS: a,
        IPAD: s,
        SUPPORT_FS: l,
...
, function(e, t, n) {
    ...
    e.exports.sec2str = function(e) {
        var t = parseInt(e)
          ...
          , i = ("0" + Math.floor(t / 3600) % 24).slice(-2)
          , r = ("0" + Math.floor(t / 60) % 60).slice(-2)
          , o = ("0" + t % 60).slice(-2);
        return (n > 0 ? n + "d " : "") + (i > 0 ? i + ":" : "") + r + ":" + (t > 60 ? o : o + "")
    }
    ,
    e.exports.getMatchAttr = function(e, t) {
        for (var n = e.attributes, i = n.length; i--; )
            if (0 === n[i].nodeName.indexOf(t))
                return {
                    nodeName: n[i].nodeName,
                    name: n[i].nodeName.split(t)[1],
                    value: n[i].value
                };
        return null
    }
      ...
      , l = function() {
        ...
        return r(e, [{
            ...
            value: function(e) {
                var t = this
                  , n = this.player
                  , i = n.isVideo ? "video" : "audio"
                  , r = document.createElement("script")
                  , a = o.SCRIPT_PATH + "/skin/" + n.opt.skin;
                if (r.src = a + "/tpl." + i + ".js",
                n.el.parentNode.insertBefore(r, n.el),
                0 === document.querySelectorAll('link[href*="' + a + '"]').length) {
                    var l = document.createElement("link");
                    l.setAttribute("rel", "stylesheet"),
                    l.setAttribute("href", a + "/skin.min.css"),
                    document.body.appendChild(l)
                }
                "function" == typeof e && r.addEventListener("load", function() {
                    e.call(t, s[n.opt.skin + "-" + i])
                })
            }
        }, {
            key: "createInterface",
            value: function(e) {
                ...
                r.outerHTML = e,
                i.container = n.previousElementSibling,
                i.container.querySelector(".mp-media-el").appendChild(n),
                n.classList.add("el"),
                n.controls = !1,
                n.setAttribute("playsinline", ""),
                n.setAttribute("tabindex", "0"),
                o.UA.indexOf("MSIE 9") > -1 && i.container.classList.add("mp-is-ie9"),
                o.IOS && i.container.classList.add("mp-is-ios"),
                t.opt.contextmenu && (i.contextmenu = new a.default(o.DEFAULT_CONTEXT_MENU,t))
            }
        }, {
            key: "removeInterface",
            value: function() {
        ...
        o(t, [{
            ...
            value: function() {
                ...
                if (a.SUPPORT_FS) {
                    ...
                    if (!1 === Boolean(n)) {
                        var i = e.requestFullscreen || e.mozRequestFullScreen || e.webkitRequestFullScreen || e.msRequestFullscreen;
                        i && i.call(e)
                    } else {
                        var r = document.exitFullscreen || document.mozCancelFullScreen || document.webkitCancelFullScreen || document.msExitFullscreen;
                        r && r.call(document)
                    }
                } else
                    a.IOS && !a.IPAD ? (this.player.el.pause(),
                    this.player.el.removeAttribute("playsinline"),
                    this.player.el.play()) : e.classList.contains("mp-is-fullscreen") ? (e.classList.remove("mp-is-fullscreen"),
                    t.classList.remove("mp-is-fullscreen"),
                    t.innerHTML = t.getAttribute("data-first-text")) : (e.classList.add("mp-is-fullscreen"),
                    t.classList.add("mp-is-fullscreen"),
            ...
            value: function() {
                ...
                !1 === Boolean(n) && (e.classList.remove("mp-is-fullscreen"),
                t.classList.remove("mp-is-fullscreen"),
                t.innerHTML = t.getAttribute("data-first-text")),
                !0 === Boolean(n) && n == e && (e.classList.add("mp-is-fullscreen"),
                t.classList.add("mp-is-fullscreen"),
                t.innerHTML = t.getAttribute("data-second-text"))
            }
        }, {
      ...
      , a = function() {
        ...
        return i(e, [{
            ...
            value: function() {
                ...
                r.ELEMENT_EVENT_LIST.forEach(function(t) {
                ...
                [].forEach.call(t.querySelectorAll("a, button, input, [tabindex]"), function(t) {
                    t.addEventListener("focus", function() {
                        return e.player.ui.container.classList.add("mp-is-focus")
                    }),
                    t.addEventListener("focus", e.activeFocus.bind(e)),
                    t.addEventListener("blur", function() {
                        return e.player.ui.container.classList.remove("mp-is-focus")
                    })
                }),
                ...
                t.addEventListener("mouseout", function() {
                    return t.classList.remove("mp-is-active")
                }, !1),
            ...
            value: function(e, t) {
                ...
                this.player.userEvents.forEach(function(e) {
                    e.eventName === i && e.handler.call(n.player, r)
                })
            }
        }, {
            key: "updateBuffered",
            value: function() {
                ...
                0)
                  , a = 0;
                try {
                    for (; !(i.start(n) <= r && r <= i.end(n)); )
                        n += 1;
                    o = i.start(n) / e.duration * 100,
                    a = i.end(n) / e.duration * 100 - o,
                    t.style.width = a + "%",
                    t.style.left = o + "%"
                } catch (e) {}
            }
            ...
            value: function() {
                var e = this.player
                  ...
                  , r = e.ui.totalTime
                  , a = e.ui.btnMute;
                n && (t.paused ? (n.classList.remove("mp-is-paused"),
                n.innerHTML = n.getAttribute("data-first-text")) : (n.classList.add("mp-is-paused"),
                n.innerHTML = n.getAttribute("data-second-text"))),
                t.paused ? e.ui.container.classList.remove("mp-is-playing") : e.ui.container.classList.add("mp-is-playing"),
                i && (e.ui.currentTime.innerHTML = (0,
                o.sec2str)(t.currentTime)),
                r && (e.ui.totalTime.innerHTML = (0,
                o.sec2str)(t.duration)),
                a && (t.muted ? (a.classList.add("mp-is-muted"),
                a.innerHTML = a.getAttribute("data-second-text")) : (a.classList.remove("mp-is-muted"),
                a.innerHTML = a.getAttribute("data-first-text")))
            }
        }, {
            ...
            value: function() {
                var e = this.player.ui.container
                  , t = (0,
                o.getMatchAttr)(e, "data-maxwidth-")
                  , n = (0,
                o.getMatchAttr)(e, "data-minwidth-")
                  , i = 0;
                null !== t && (i = parseInt(t.name),
                e.offsetWidth <= i ? e.classList.add(t.value) : e.classList.remove(t.value)),
                null !== n && (i = parseInt(n.name),
                e.offsetWidth >= i ? e.classList.add(n.value) : e.classList.remove(n.value))
            }
        }, {
            key: "active",
            value: function() {
                var e = this.player.ui.container;
                e.classList.remove("mp-is-active-focus"),
                e.classList.add("mp-is-active"),
                clearTimeout(e.activeTimer),
                e.activeTimer = setTimeout(function() {
                    return e.classList.remove("mp-is-active")
                }, 2e3)
            }
        }, {
            key: "activeFocus",
            value: function() {
                var e = this.player.ui.container;
                e.classList.remove("mp-is-active"),
                e.classList.add("mp-is-active-focus"),
                clearTimeout(e.activeTimer),
                e.activeTimer = setTimeout(function() {
                    return e.classList.remove("mp-is-active-focus")
                }, 2e3)
            }
        }, {
            key: "contextmenu",
            ...
            value: function(e) {
                var t = this.player;
                if (t.ui.container.classList.contains("mp-is-focus"))
                    switch (e.keyCode) {
                    case 32:
                        e.preventDefault(),
                        t.togglePlay();
            ...
            value: function(e) {
                ...
                this.player.ui.container.seekTimer = setTimeout(function() {
                    return t.player.ui.container.classList.remove("mp-is-seeking")
                }, 800),
                this.callback(e)
            }
        }, {
        ...
        return i(e, [{
            ...
            value: function(e) {
                var t = e.touches ? this.isX ? e.touches[0].pageX : e.touches[0].pageY : this.isX ? e.pageX : e.pageY
                  ...
                  , i = t - this.offsetPos
                  , r = 0;
                this.isDown && n && (r = this.isX ? Math.round(i / this.rangeSize * 100) : Math.round((this.rangeSize - i) / this.rangeSize * 100),
                this.position = r,
          ...
          , p = function(e) {
            function t(e, n) {
                ...
                var a = r(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this))
                  , l = o({}, s.DEFAULT_OPTIONS);
                return a.opt = o(l, n),
                a.el = "string" == typeof e ? document.querySelector(e) : e,
                a.prevEl = a.el.cloneNode(!0),
                a.isVideo = "VIDEO" === a.el.tagName,
                a.wrapper = a.isVideo ? new u.default(a) : new c.default(a),
                a.initFlag = !1,
                a.userEvents = [],
                a.init(),
                i = a,
        ...
        if ("Element"in e) {
            ...
            n.defineProperty) {
                ...
                try {
                    ...
                    -2146823252 === e.number && (c.enumerable = !1,
                    n.defineProperty(t, "classList", c))
                }
            } else
                n.prototype.__defineGetter__ && t.__defineGetter__("classList", u)
        }
    }(self))
}
, function(e, t, n) {
    ...
    var o = Object.assign || function(e) {
      ...
      , c = function(e) {
        function t(e) {
            ...
            return i.player.events = new u.default(i.player),
            n = i,
            r(i, n)
        }
        return function(e, t) {
        ...
        a(t, [{
            ...
            value: function(e) {
                ...
                var n = this.player
                  ...
                  , r = n.opt
                  , a = n.ui.container
                  , s = a.querySelector(".mp-poster")
                  , u = i.getAttribute("poster")
                  , c = a.querySelector(".mp-progress")
                  , p = a.querySelector(".mp-volume")
                  , f = new l.default({
                    el: c
                })
                  , d = new l.default({
                ...
                if (u && "" !== u ? s.setAttribute("style", "background-image: url(" + u + ");") : a.removeChild(s),
                !r.width && i.hasAttribute("width")) {
                    var h = i.getAttribute("width");
                    r.width = h.indexOf("%") > -1 ? h : h + "px"
                }
                if (!r.height && i.hasAttribute("height")) {
                    var y = i.getAttribute("height");
                    r.height = y.indexOf("%") > -1 ? y : y + "px"
                }
                r.width && (a.style.width = r.width),
                r.height && (a.style.height = r.height),
                r.flexible && a.classList.add("mp-is-flexible"),
                n.ui = o(n.ui, {
                    poster: s,
                    videoWrap: a.querySelector(".mp-media-el"),
                    progressBar: c,
                    buffered: c.querySelector(".mp-buffered"),
                    volumeBar: p,
                    progress: f,
                    volume: d,
                    currentTime: a.querySelector(".mp-current-time"),
                    totalTime: a.querySelector(".mp-total-time"),
                    btnPlay: a.querySelector(".mp-btn-play"),
                    btnPause: a.querySelector(".mp-btn-pause"),
                    btnPlayPause: a.querySelector(".mp-btn-play-puase"),
                    btnStop: a.querySelector(".mp-btn-stop"),
                    btnFullscreen: a.querySelector(".mp-btn-fullscreen"),
                    btnMute: a.querySelector(".mp-btn-mute")
                })
            }
        }]),
        t
      ...
      , o = function() {
        ...
        return i(e, [{
            ...
            value: function(e) {
                ...
                r.closest)(e.target, ".mplayer"))
                    return !1;
                for (var t = document.querySelectorAll(".mplayer-context-menu"), n = 0, i = t.length; n < i; ++n)
            ...
            value: function(e) {
                var t = this.el
                  ...
                  , l = e.clientY + r
                  , u = e.clientX + o;
                u >= s && (this.el.classList.add("mplayer-context-dir-left"),
                u = s),
                l >= a && (this.el.classList.add("mplayer-context-dir-top"),
                l = a),
                t.style.top = l + "px",
                t.style.left = u + "px"
            }
      ...
      , c = function(e) {
        ...
        a(t, [{
            ...
            value: function(e) {
                ...
                n.opt,
                n.ui.container)
                  , r = i.querySelector(".mp-progress")
                  , a = i.querySelector(".mp-volume")
                  , s = new l.default({
                    el: r
                })
                  , u = new l.default({
                ...
                n.ui = o(n.ui, {
                    progressBar: r,
                    buffered: r.querySelector(".mp-buffered"),
                    volumeBar: a,
                    progress: s,
                    volume: u,
